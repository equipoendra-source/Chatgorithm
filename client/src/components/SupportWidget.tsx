...
const SUPPORT_CONFIG = {
    whatsapp: {
        ...
        message: 'Hola, necesito ayuda con la aplicación Chatgorim'
    },
    phone: {
        enabled: true,
    ...
    email: {
        ...
        subject: 'Solicitud de Soporte - Chatgorim'
    },
    docs: {
    ...
    return (
        <>
            ...
            <button
                ...
                className="fixed bottom-40 right-4 z-40 bg-gradient-to-br from-blue-600 to-indigo-600 text-white p-3 rounded-full shadow-lg shadow-blue-200 hover:shadow-xl hover:scale-110 transition-all duration-300 group md:bottom-6 md:right-6 md:p-4"
                    ...
                    <div className={`w-full sm:max-w-md rounded-t-3xl sm:rounded-2xl shadow-2xl overflow-hidden animate-in slide-in-from-bottom-10 sm:zoom-in-95 duration-300 ${isDark ? 'bg-slate-800' : 'bg-white'}`}>
                        ...
                        <div className="bg-gradient-to-r from-blue-600 to-indigo-600 p-6 text-white relative overflow-hidden">
                            ...
                            <button
                                ...
                                className="absolute top-4 right-4 p-2 hover:bg-white/20 rounded-full transition z-20"
                            >
                                <X className="w-5 h-5" />
                            </button>
